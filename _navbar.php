...
$main_menus = [
  ...
  #'browse by DDC' => [
  #  'text' => __('DDC'),
  #  'url' => 'index.php?p=mainsubject'
  #  ],

  #'browse by color' => [
  #  'text' => __('Koleksi'),
  #  'url' => 'index.php?p=browse_by_color'
  #  ],
  ...
  #'help' => [
  #'text' => __('JatuhTempo'),
  #'url' => 'index.php?p=lambat'
  #],

  #'help' => [
  #'text' => __('SARAN'),
  #'url' => 'index.php?p=suggestion_box'
  #],

  #'help' => [
  #'text' => __('perpanjang'),
  #'url' => 'index.php?p=perpanjang'
  #],
...
HTML;
          ...
          <?php } else { ?>
            ...
            <a class="nav-link dropdown-toggle" href="#" data-toggle="dropdown">Koleksi</a>
            <div class="dropdown-menu bg-blue-lighter dropdown-menu-lg-left" aria-labelledby="dropdownMenuButton">   
              <a class="dropdown-item" href="index.php">Pencarian Sederhana</a>
              <a class="dropdown-item" href="index.php?p=mainsubject">Menurut DDC</a>
              <a class="dropdown-item" href="index.php?p=browse_by_color">Berdasar Warna</a>
            </div>
          </li>
          ...
          <li class="nav-item dropdown">
            ...
            <div class="dropdown-menu bg-blue-lighter dropdown-menu-lg-left" aria-labelledby="dropdownMenuButton">   
              <a class="dropdown-item" href="index.php?p=libinfo">Perpustakaan</a>
              <a class="dropdown-item" href="index.php?p=news">Berita</a>
              <a class="dropdown-item" href="index.php?p=lambat">Jatuh Tempo</a>
            </div>
          </li>

          <li class="nav-item dropdown">
            <a class="nav-link dropdown-toggle" href="#" data-toggle="dropdown">Daftar/LOGIN</a>
            <div class="dropdown-menu bg-bluelight dropdown-menu-lg-left" aria-labelledby="dropdownMenuButton">   
              <a class="dropdown-item" href="index.php?p=member&sec=title_basket">Login Anggota</a>
              <a class="dropdown-item" href="index.php?p=daftar_online">Daftar Online</a>
              <a class="dropdown-item" href="index.php?p=login">ADMIN</a>
              <a class="dropdown-item" href="index.php?p=usul_online">Usul Buku</a>
              <a class="dropdown-item" href="index.php?p=saran_online">Saran</a>
            </div>
          </li>
